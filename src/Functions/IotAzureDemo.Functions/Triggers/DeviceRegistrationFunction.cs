...
namespace IotAzureDemo.Functions.Triggers
{
    public static class DeviceRegistrationFunction
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "devices")]HttpRequestMessage req, TraceWriter log)
        {
            try
            {
            ...
            {
                log.Error("Failed to create devices", ex);
